...
void	f_add	(float *reg, uint8_t *ra, instr_s *instr);
void	f_b	(float *reg, uint8_t *ra, instr_s *instr);
void	f_cmp	(float *reg, uint8_t *ra, instr_s *instr);
void	f_load	(float *reg, uint8_t *ra, instr_s *instr);
void	f_move	(float *reg, uint8_t *ra, instr_s *instr);
void	f_mul	(float *reg, uint8_t *ra, instr_s *instr);
void	f_pow	(float *reg, uint8_t *ra, instr_s *instr);
void	f_print	(float *reg, uint8_t *ra, instr_s *instr);
void	f_read	(float *reg, uint8_t *ra, instr_s *instr);
void	f_stop	(float *reg, uint8_t *ra, instr_s *instr);
void	f_sub	(float *reg, uint8_t *ra, instr_s *instr);
